...
Button(root, text='exp', command=lambda:(get_operator('**'))).grid(row=3, column=4, sticky=W+E)
Button(root, text ='^2', command=lambda:(get_operator('**2'))).grid(row=3, column=5, sticky=W+E)
